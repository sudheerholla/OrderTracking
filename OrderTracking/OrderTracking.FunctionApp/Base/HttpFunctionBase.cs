...
namespace OrderTracking.FunctionApp.Base
{
    /// <summary>
    ...
    public abstract class HttpFunctionBase
    {
            ...
            where TRequest : IRequest<TResponse>
        {
            ...
            catch (Application.Exceptions.ValidationException validationException)
            {
            ...
            catch (Application.Exceptions.NotFoundException notFoundException)
            {
            ...
            catch (Application.Exceptions.DuplicateItemException duplicateException)
            {
                var details = new ProblemDetails()
                {
